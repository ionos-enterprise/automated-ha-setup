...
RETURNS record
AS '/usr/pgpool-10/bin/pcp_node_info', 'pcp_node_info'
...
RETURNS record
AS '/usr/pgpool-10/bin/pcp_pool_status', 'pcp_pool_status'
LANGUAGE C VOLATILE STRICT;
...
RETURNS integer
AS '/usr/pgpool-10/bin/pcp_node_count', 'pcp_node_count'
LANGUAGE C VOLATILE STRICT;
...
RETURNS boolean
AS '/usr/pgpool-10/bin/pcp_attach_node', 'pcp_attach_node'
LANGUAGE C VOLATILE STRICT;
...
RETURNS boolean
AS '/usr/pgpool-10/bin/pcp_detach_node', 'pcp_detach_node'
LANGUAGE C VOLATILE STRICT;
